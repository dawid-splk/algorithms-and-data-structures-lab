...
public class Zad1 {
    ...
    private static final KolejkaPriorytetowa<Klient> kolejka = new KolejkaPriorytetowa<>(new Comparator<Klient>() {
        @Override
        public int compare(Klient o1, Klient o2) {
            return Integer.compare(o1.getCzasSprawy(), o2.getCzasSprawy());
        }
    });
            ...
            for (Urzednik u : listaUrzednikow) {
                if (!u.getZajety()) {
                    try {
                        ...
                        System.out.println("Urzednik " + u.getImie() + " zaczal obslugiwac nowego klienta: " + u.getObecnyKlient());
                        warunek = true;
